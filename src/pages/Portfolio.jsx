...
const Portfolio = () => {
  return (
    <div className='2xl:px-[18px] bg-gray-900 sm:px-2 w-full min-h-screen py-10'>

      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-3 w-[100%] px-12 m-auto gap-3 '>

        {/* E-Commerce Project */}
        <div className=' shadow-2xl w-[390px] h-[530px] bg-black text-white px-3 py-5 '>
          <img src={img} alt="" className='px-2 pb-3' />
          <h1 className='font-bold text-[18px] '>1 Title:- <span>E-Commerce Project</span></h1>
          <h1 className='mt-4 text-[15px] font-bold'>2 Description:- </h1>
          ...
          <h1 className='mt-2 text-[15px] font-bold '>3 Features:- </h1>
          <h3 className='text-[12px] font-semibold '>Search Bar with Suggestions,Add To Cart,View To Cart,Delete Item,Automatice Calculate Amount </h3>
          <h1 className='mt-2 text-[15px] font-bold '>4 Tech Stack</h1>
          <h3 className='text-[12px] font-semibold '>React.js – Component-based architecture,Tailwind CSS,Context API,Swiper.js,React Icons</h3>
          <h3 className='text-[15px] font-bold '> Vercel Live Demo :- <a href="https://e-commerceproject77.vercel.app/" target="_blank" className="text-blue-700 font-semibold text-[12px]">https://e-commerceproject77.vercel.app/</a></h3>          
        </div>


            <div className=' shadow-2xl w-[390px] h-[530px] bg-black text-white px-3 py-5 '>
          <img src={img5} alt="" className='px-2 pb-3' />
          <h1 className='font-bold text-[18px] '>1 Title:- <span>Book-Hub Project</span></h1>
          <h1 className='mt-4 text-[15px] font-bold'>2 Description:- </h1>
          <span className='text-[13px] font-semibold '>
            A fully responsive Book-Hub frontend with smooth animations, interactive product cards, and a clean shopping experience.
          </span>
          <h1 className='mt-2 text-[15px] font-bold '>3 Features:- </h1>
          <h3 className='text-[12px] font-semibold '>Search Bar with Suggestions,Explore More,Add To Cart,Buy Now,Filter </h3>
          <h1 className='mt-2 text-[15px] font-bold '>4 Tech Stack</h1>
          <h3 className='text-[12px] font-semibold '>React.js – Component-based architecture,Tailwind CSS,Context API,Swiper.js,React Icons</h3>
          <h3 className='text-[15px] font-bold '> Vercel Live Demo :- <a href="https://book-hubproject.vercel.app" target="_blank" className="text-blue-700 font-semibold text-[12px]">https://book-hubproject.vercel.app/</a></h3>          
        </div>
        ...
        {/* SundownStudio Project */}
        <div className='shadow-2xl w-[390px] h-[530px] bg-black text-white px-3 py-5'>
          <img src={img2} alt="" className='px-2 pb-3' />
          <h1 className='font-bold text-[18px]'>1 Title:- <span>SundownStudio Project</span></h1>
          <h1 className='mt-4 text-[15px] font-bold'>2 Description:- </h1>
          <span className='text-[13px] font-semibold'>
            A fully responsive SundownStudio Project frontend with smooth animations, interactive Project
          </span>
          <h1 className='mt-1  text-[15px] font-bold'>4 Tech Stack</h1>
          <h3 className='text-[12px] font-semibold '>CSS – Styling,CSS,Animation</h3>
          
          <h3 className='md:text-[10px] sm:text-[14px] xl:text-[15px] xl:w-[380px] font-bold'> Vercel Live Demo :- <a href="  https://sundownstudio-beta.vercel.app/" target="_blank" className="text-blue-700 font-semibold text-[12px]">  https://sundownstudio-beta.vercel.app/</a></h3>
        
        </div>

        {/* Alarm Clock Project */}
        <div className='shadow-2xl w-[390px] h-[530px] bg-black text-white px-3 py-5'>
          <img src={img3} alt="" className='sm:w-[300px] sm:h-[250px] m-auto sm:py-5 px-2 pb-3 ' />
          <h1 className='mt-4 text-[15px] font-bold'>1 Title:- <span>Alarm Clock Project</span></h1>
          ...
          <h3 className='md:text-[10px] sm:text-[14px] xl:text-[15px] xl:w-[380px]   font-bold'> Vercel Live Demo :- <a href="  https://alarmclock-woad.vercel.app/" target="_blank" className="text-blue-700 font-semibold text-[11px]">  https://https://alarmclock-woad.vercel.app/</a></h3>
        </div>
  {/* *********************************************************************************** */}

<div className='shadow-2xl w-[390px] h-[530px] bg-black text-white px-3 py-5'>
          <img src={img4} alt="" className='sm:w-[300px] sm:h-[250px] m-auto sm:py-5 px-2 pb-3' />
          <h1 className='mt-4 text-[15px] font-bold'>1 Title:- <span>E-commerce Project</span></h1>
          <h1 className='mt-2 text-[15px] font-bold'>2 Description:- </h1>
          <span className='text-[13px] font-semibold'>
